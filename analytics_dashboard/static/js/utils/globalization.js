...
var LANGUAGE_CODE = fixLanguageCode(window.language);

define([
  'globalize',
  'vendor/json!vendor/cldr/supplemental/likelySubtags.json',
  'vendor/json!vendor/cldr/main/' + LANGUAGE_CODE + '/numbers.json',
  'globalize/number'
  ...
  return Globalize(LANGUAGE_CODE);
});
